...
let activePlayer = 'X';
//This array stores an arra of moves.We use this to determine win conditions.
let selectedSquares = [];
...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        //This variable retrieves the HTML element id that was clickrd.
        ...
        //This functin plays placement sound.
        ...
        //Returning true is needed fot our computersTurn() functin to work.
        return true;
    }
    ...
    function computersTurn() {
        ...
        while (!success) {
            ...
            //If the random number evaluetad returns true, the square hasn't been selected yet.
...
function checkWinConditions() {
    ...
    // O 6, 4, 2 condition.
    else if (arrayIncludes('60', '40', '20')) { drawWinLine(100, 58, 510, 90) }
    // O 0, 4, 8 condition.
...
function disableClick() {
    //This makes our body uncluckable.
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    y1 = coordY1,
    //This line indicates where the end of a lones x axis is.
    x2 = coordX2,
